        ...
        for i, (images, paths) in predict_process_bar:
            ...
            for j in range(len(paths)):
                ...
                try:
                    ...
                    print(f"[\033[91mError\033[0m] Error copying file [\033[91m{pred_file}\033[0m] to destination: {e}")
        ...
        if n == 0:
            ...
            if user_input == '':
                ...
                try:
                    ...
                    print(f"[\033[91mError\033[0m] Invalid input ({user_input}), must be a float between 0 and 1. Skipped.")
                    target = None
