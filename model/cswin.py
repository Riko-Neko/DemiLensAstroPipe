...
class CSWinTransformer(nn.Module):
    ...
    def __init__(self, img_size = 96, patch_size = 16, in_chans = 3, num_classes = 1, embed_dim = 96,
                 depth = [2, 2, 6, 2], split_size = [3, 5, 7],
                 num_heads = [3, 6, 12, 24], mlp_ratio = 4., qkv_bias = True, qk_scale = None, drop_rate = 0.,
                 attn_drop_rate = 0.,
